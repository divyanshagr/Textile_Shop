...
<form:form method="post" modelAttribute="employee" action="update">
	<table class="table table-hover">
		<tr>
			<td>password</td>
			<td><form:input required="required" path="password"
					type="password" /></td>
			<!-- bind to user.name-->
		...
		<tr>
			...
			<td><form:input required="required" path="mpassword"
					type="password" /></td>
			<!-- bind to user.name-->
			<td><form:errors path="mpassword" /></td>
		</tr>

		<tr>
			<td>First Name</td>
			<td><form:input required="required" path="fname" type="text" />
			</td>
			<!-- bind to user.name-->
		...
		<tr>
			<td>Middle Name</td>
			<td><form:input path="mname" type="text" /></td>
			<!-- bind to user.name-->
		...
		<tr>
			<td>House No.</td>
			<td><form:input path="hno" type="text" /></td>
			<!-- bind to user.name-->
			<td><form:errors path="hno" /></td>
		</tr>

		<tr>
			<td>PIN</td>
			<td><form:input path="pin" type="number" min="100000"
					max="999999" /></td>
			<!-- bind to user.name-->
		...
		<tr>
			<td>Salary</td>
			<td><form:input required="required" path="salary" type="number"
					min="0" /></td>
			<!-- bind to user.name-->
