			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="/OnlineSite/">Home</a>
						</li>

						<li class="nav-item"><a class="nav-link" href="/OnlineSite/login">Sign in</a></li>

						<li class="nav-item"><a class="nav-link" href="/OnlineSite/register">Sign up</a>
						</li>
					</ul>
				</div>
			</div>
